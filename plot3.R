...
# Plot 3, line plot of the 3 Energy Submetering series
png(filename = "plot3.png", width = 480, height = 480)
with(data, plot(DateTime, Sub_metering_1, type = "l", main = "Enerby sub metering",
                ylab = "Energy sub metering (watt-hour of active energy)"))
